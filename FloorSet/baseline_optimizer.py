...
class MyOptimizer(FloorplanOptimizer):
    ...
    def solve(
        ...
        high_state = SearchState(BStarTree(high_payloads, deterministic=True), shape, groups)
        ...
        low_payloads = sorted(movable, key=lambda bid: (high_positions[bid][1], high_positions[bid][0]))
        low_state = SearchState(BStarTree(low_payloads, deterministic=True), high_state.shape, {})
